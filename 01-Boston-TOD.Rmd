...
- Who is living around transit stations in Boston? 
- How does the social, economic, and demographic characteristics of households living near transit stations in Boston change over time? 
- Are Bostonians willing to pay a premium to live in transit-rich areas? 
- How can planners in Boston be more strategic about developments in transit-rich neighborhoods? 
- What are the limitations of this methodology to predict transit-oriented development? 
...
packages <- c( "tidyverse", "ggplot2", "svDialogs", "tidycensus", "sf", "knitr", "rmarkdown", "kableExtra", "stringr")
...
```{r}
ggplot() +
  geom_sf(data=st_union(boston10)) +
  geom_sf(data=stops_summary, aes(size=total_population, color = stops)) +
  scale_size(range = c(0.5, 4), name = "Population") +    
